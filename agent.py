...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = math.fabs(math.cos(self.decay_constant * self.trial_counter))
    ...
    def choose_action(self, state):
        ...
        if not self.learning or random.random() < self.epsilon:
            ...
            #        actions.append(act)
            actions = [action for action, q_value in self.Q[state].iteritems() if q_value == maxQ]
...
def run():
    ...
    sim.run(n_test=15, tolerance=0.05)
